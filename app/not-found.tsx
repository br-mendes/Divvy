  ...
  return (
    <StaticPageLayout>
      <div className="flex flex-col items-center justify-center px-4 text-center py-16">
        ...
        <h1 className="text-6xl font-display font-black text-gray-900 dark:text-white mb-4 tracking-tighter">404</h1>
        <h2 className="text-2xl font-display font-bold text-gray-800 dark:text-gray-200 mb-4">Página não encontrada</h2>
