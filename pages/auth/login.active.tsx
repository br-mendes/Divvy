        ...
        <div className="min-h-screen bg-gray-50">
           <header className="sticky top-0 z-10 border-b border-gray-200 bg-white">
             <div className="max-w-7xl mx-auto px-4 py-4">
               <Link href="/" className="inline-flex items-center gap-2 group">
                 ...
                 <span className="text-xl font-display font-bold text-gray-900">Divvy</span>
               </Link>
             </div>
           </header>
           <div className="flex items-center justify-center px-4 py-10">
             <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-md border border-gray-100 text-center">
              ...
              <h2 className="text-2xl font-display font-bold text-gray-900 mb-2">Verificação em Duas Etapas</h2>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex items-center justify-center px-4 py-10">
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          Ainda não tem conta? <Link href={`/auth/signup${router.query.redirect ? `?redirect=${router.query.redirect}` : ''}`} className="text-brand-600 font-bold hover:underline">Cadastre-se grátis</Link>
        </p>
      </div>
      </div>
    </div>
