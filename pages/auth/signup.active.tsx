    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex items-center justify-center px-4 py-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold mt-4">Criar Conta</h1>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          Já tem conta? <Link href={`/auth/login${router.query.redirect ? `?redirect=${router.query.redirect}` : ''}`} className="text-brand-600 font-bold hover:underline">Fazer login</Link>
        </p>
      </div>
      </div>
    </div>
