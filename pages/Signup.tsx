...
export const Signup: React.FC = () => {
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    try {
      // Use getURL() adapted for HashRouter/SPA environment
      // Pointing to the new callback route which handles the code exchange
      ...
      if (data.user) {
        ...
        if (profileError) {
          ...
          // We don't throw here to allow the signup flow to complete 
          // even if profile creation hits a snag (e.g. RLS issues)
        }
      }
      ...
      <div className="w-full max-w-md bg-white p-6 sm:p-8 rounded-lg sm:rounded-lg border border-gray-200 shadow-sm sm:shadow-md">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <Button
            ...
            isLoading={loading}
            disabled={loading}
            size="lg" // Matches the requested size
            className="h-12" // Ensure visual consistency if size props differ slightly
          >
